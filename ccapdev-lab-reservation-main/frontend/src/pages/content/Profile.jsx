        ...
        try {
            ...
            try {
                if (otherID) {
                    ...
                    const resResponse = await fetch(`${process.env.REACT_APP_API_URL.replace(/\/$/, "")}/api/reservations/deleteAll/${otherID}`, {
                        method: "DELETE",
                    });
            ...
            try {
                ...
                const response = await fetch(`${process.env.REACT_APP_API_URL.replace(/\/$/, "")}/api/profile/delete/${userID}`, {
                    method: "DELETE",
                });
